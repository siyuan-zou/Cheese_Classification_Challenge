...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        self.instance_images_path = [path for path in Path(instance_data_root).iterdir() if not path.name.endswith('.DS_Store')]
        self.num_instance_images = len(self.instance_images_path)
        # self.instance_prompt = instance_prompt
        self._length = self.num_instance_images
        with open("semantic_captionning_validation.json", "r") as f:
            captionning = json.load(f)
        self.captionning = captionning
    ...
    def __getitem__(self, index):
        ...
        text = self.captionning["./" + str(self.instance_images_path[index % self.num_instance_images])]
