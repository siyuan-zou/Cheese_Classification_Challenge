...
class SDfinetuneGenerator:
    def __init__(
        self,
    ):
        
        self.pipe = StableDiffusionPipeline.from_pretrained('/Data/zou.siyuan/Chellenge_Cheese/cheese_chellenge', torch_dtype=torch.float32).to(device)
